...
<html>
    ...
    <body>
        ...
        <div id="show-flight" class="content scaffold-show" role="main">
            ...
            <f:display bean="flight" />
            <g:form resource="${this.flight}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.flight}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
